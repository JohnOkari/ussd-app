...
class FarmersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create farmer" do
    assert_difference("Farmer.count") do
      post farmers_url, params: { farmer: { contact_infomation: @farmer.contact_infomation, location: @farmer.location } }
    end
  ...
  test "should update farmer" do
    patch farmer_url(@farmer), params: { farmer: { contact_infomation: @farmer.contact_infomation, location: @farmer.location } }
