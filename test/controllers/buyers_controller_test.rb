...
class BuyersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create buyer" do
    assert_difference("Buyer.count") do
      post buyers_url, params: { buyer: { farmer_id: @buyer.farmer_id, location: @buyer.location, name: @buyer.name } }
    end
  ...
  test "should update buyer" do
    patch buyer_url(@buyer), params: { buyer: { farmer_id: @buyer.farmer_id, location: @buyer.location, name: @buyer.name } }
